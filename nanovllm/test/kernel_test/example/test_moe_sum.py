...
if __name__ == "__main__":
    ...
    electrock_infer.moe_sum(input_default, output_custom)
    ...
    electrock_infer.moe_sum_efficient(input_shfl, output_shfl)
    ...
    benchmark(lambda: electrock_infer.moe_sum(input_default, output_bench1), "Custom Kernel (moe_sum)")

    # c) 您的 vector Kernel
    output_bench2 = torch.empty_like(expected_output)
    benchmark(lambda: electrock_infer.moe_sum_efficient(input_shfl, output_bench2), "Custom Kernel (vector)")
