...
from electrock_infer.layers.moe.moe_align_block_size import moe_align_block_size
...
def fused_topk(
    ...
    use_torch = True
    if use_torch:
        from electrock_infer.layers.moe.softmax_topk import topk_softmax_torch
...
def fused_experts(
    ...
    if activation == "silu":
        ...
        _C.silu_and_mul(intermediate_cache2, intermediate_cache1.view(-1, intermediate_size_x2))
    else:
        # 如果需要其他激活函数，可以在这里添加
    ...
    _C.moe_sum(intermediate_cache3, output)
