...
from electrock_infer.layers.attention import NaiveKVCacheAttention


"""Inference-only Mixtral model.
    该版本针对先导杯进行定制化, 特性如下:
    1. Attention层不再使用paged_attention --> NaiveKVCacheAttention
"""
...
class MixtralAttention(nn.Module):
    ...
    def __init__(
        ...
        self.attn = NaiveKVCacheAttention(
                                        self.num_heads,
                                        self.head_dim,
                                        self.scaling,
